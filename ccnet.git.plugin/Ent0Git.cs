...
namespace ThoughtWorks.CruiseControl.Core.Sourcecontrol
{
	...
	public class Ent0Git : ProcessSourceControl
	{
		...
		public Ent0Git() : this(new Ent0GitHistoryParser(), new ProcessExecutor(), new SystemIoFileSystem(), new IoService()) { }

		public Ent0Git(IHistoryParser historyParser, ProcessExecutor executor, IFileSystem fileSystem, IFileDirectoryDeleter fileDirectoryDeleter)
		...
		{
			// fetch latesst changes from the remote repository
